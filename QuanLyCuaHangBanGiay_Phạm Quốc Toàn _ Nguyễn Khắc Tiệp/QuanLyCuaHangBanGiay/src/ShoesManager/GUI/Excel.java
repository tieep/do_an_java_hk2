...
public class Excel extends javax.swing.JFrame implements MouseListener {
    ...
    private void initComponents() {
        ...
        rdbtnThongTin_MauXanh = new javax.swing.JRadioButtonMenuItem();
        ...
        buttonGroup_MauNen.add(rdbtnThongTin_MauXanh);
        rdbtnThongTin_MauXanh.setSelected(true);
        rdbtnThongTin_MauXanh.setText("Màu xanh/ trắng");
        rdbtnThongTin_MauXanh.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseReleased(java.awt.event.MouseEvent evt) {
                rdbtnThongTin_MauXanhMouseReleased(evt);
            }
        });
        rdbtnThongTin_MauXanh.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rdbtnThongTin_MauXanhActionPerformed(evt);
            }
        });
        MenuMauNen.add(rdbtnThongTin_MauXanh);
    ...
    private void rdbtnThongTin_MauXanhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rdbtnThongTin_MauXanhActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_rdbtnThongTin_MauXanhActionPerformed

    private void rdbtnThongTin_MauXanhMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_rdbtnThongTin_MauXanhMouseReleased
        Memory.colorThemes = new Color(0, 255, 200);
    ...
    }//GEN-LAST:event_rdbtnThongTin_MauXanhMouseReleased
    ...
    private javax.swing.JRadioButtonMenuItem rdbtnThongTin_MauXanh;
